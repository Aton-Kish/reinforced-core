...
public class ModScreenHandlerType {
  public static final Map<ReinforcingMaterial, ScreenHandlerType<ReinforcedStorageScreenHandler>>
  ...
  private static ScreenHandlerType<ReinforcedStorageScreenHandler> register(
      String id, ScreenHandlerType.Factory<ReinforcedStorageScreenHandler> factory) {
    Identifier identifier = Identifier.of(ReinforcedCoreMod.MOD_ID, id);
    ScreenHandlerType<ReinforcedStorageScreenHandler> type =
        new ScreenHandlerType<ReinforcedStorageScreenHandler>(
            factory, FeatureFlags.VANILLA_FEATURES);
    return Registry.register(Registries.SCREEN_HANDLER, identifier, type);
  }

  private static ScreenHandlerType.Factory<ReinforcedStorageScreenHandler>
      createSingleBlockScreenHandlerFactory(ReinforcingMaterial material) {
    return (int syncId, PlayerInventory playerInventory) ->
